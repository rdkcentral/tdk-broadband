...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_TAD_CheckDNSInternetConnectivity_QueryResultWithInvalidTestURL</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_TAD_89</test_case_id>
...
18. Revert to the initial Device.Diagnostics.X_RDK_DNSInternet.Enable state if required.</automation_approch>
    ...
    <test_script>TS_TAD_CheckDNSInternetConnectivity_QueryResultWithInvalidTestURL</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_CheckDNSInternetConnectivity_QueryResultWithInvalidTestURL');
tr181obj.configureTestCase(ip,port,'TS_TAD_CheckDNSInternetConnectivity_QueryResultWithInvalidTestURL');
