...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_TAD_84</test_case_id>
    <test_objective>Check if an on-demand Internet connectivity check is triggered by enabling the parameter Device.Diagnostics.X_RDK_DNSInternet.WANInterface.{i}.QueryNow when Device.Diagnostics.X_RDK_DNSInternet.WANInterface.{i}.Enable is enabled and Device.Diagnostics.X_RDK_DNSInternet.TestURL.{i}.URL is set to a valid URL. Also check if the DNS query result retrieved using Device.Diagnostics.X_RDK_DNSInternet.WANInterface.{i}.QueryNowResult is in "CONNECTED" state (state = 1).</test_objective>
...
10. Now set a new Test URL "www.google.com"  after creating a table instance Device.Diagnostics.X_RDK_DNSInternet.TestURL. and validate with get.
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_TAD_CheckDNSInternetConnectivity_QueryResultWithValidTestURL');
tr181obj.configureTestCase(ip,port,'TS_TAD_CheckDNSInternetConnectivity_QueryResultWithValidTestURL');
...
if "SUCCESS" in loadmodulestatus.upper()and "SUCCESS" in loadmodulestatus1.upper():
    ...
    if preReqStatus == 0:
        ...
        if testURLPreReq == 0:
            #Set the Test URL to "www.google.com" to a newly created Test URL table instance
            step = step + 1;
            testURLList = ["www.google.com"];
