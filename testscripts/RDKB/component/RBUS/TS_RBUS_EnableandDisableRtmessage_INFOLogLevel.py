...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper() :
    ...
    if rbus_set == 1:
        ...
        if expectedresult in actualresult and details == "File exist":
            ...
            print("\nGet the current number of log lines of \"rdk_dyn_log_validate_component_name(): Set INFO loglevel for the component LOG.RDK.RTMESSAGE of the process rtrouted\"");
            step = 3;
            search_string_loglevelSet = "rdk_dyn_log_validate_component_name(): Set INFO loglevel for the component LOG.RDK.RTMESSAGE of the process rtrouted"
            ...
            print("\nGet the current number of log lines of \"rdk_dyn_log_validate_component_name(): Set !INFO loglevel for the component LOG.RDK.RTMESSAGE of the process rtrouted\"");
            step = 4;
            search_string_loglevelReset = "rdk_dyn_log_validate_component_name(): Set !INFO loglevel for the component LOG.RDK.RTMESSAGE of the process rtrouted"
            ...
            if expectedresult in actualresult and "Sent message to update log level of LOG.RDK.RTMESSAGE for rtrouted process" in details:
                ...
                print("\nGet the final number of log lines of \"rdk_dyn_log_validate_component_name(): Set INFO loglevel for the component LOG.RDK.RTMESSAGE of the process rtrouted\"");
                step = 6;
