...
tr181obj.configureTestCase(ip,port,'TS_IPV6_Check_LANClientReachabilityFromDUT')
sysobj.configureTestCase(ip,port,'TS_IPV6_Check_LANClientReachabilityFromDUT')
