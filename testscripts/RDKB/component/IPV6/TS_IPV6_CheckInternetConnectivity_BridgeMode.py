...
tr181obj.configureTestCase(ip,port,'TS_IPV6_CheckInternetConnectivity_BridgeMode')
sysobj.configureTestCase(ip,port,'TS_IPV6_CheckInternetConnectivity_BridgeMode')
    ...
    if expectedresult in actualresult and initial_lan_mode != "":
        ...
        if expectedresult in actualresult:
            ...
            if flag:
                ...
                #Check internet connectivity on bridge mode
                step += 1
                print("Checking IPv6 internet connectivity on bridge-static mode")
