...
tr181obj.configureTestCase(ip,port,'TS_IPV6_CheckIPV6Address_PersistenceAfterReboot')
sysobj.configureTestCase(ip,port,'TS_IPV6_CheckIPV6Address_PersistenceAfterReboot')
