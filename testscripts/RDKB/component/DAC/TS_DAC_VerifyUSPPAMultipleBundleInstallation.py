    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult and BUNDLE_DOWNLOAD_URL in details:
                ...
                print("ACTUAL RESULT %d: DeploymentUnit.1.URL verified: %s" % (step, details))
                print("[TEST EXECUTION RESULT] : SUCCESS")
                ...
                if expectedresult in actualresult and EXPECTED_DU_STATUS in details:
                    tdkTestObj_tr181.setResultStatus("SUCCESS")
                    print("ACTUAL RESULT %d: DeploymentUnit.1.Status is Installed: %s" % (step, details))
                    print("[TEST EXECUTION RESULT] : SUCCESS")
                    ...
                    if expectedresult in actualresult:
                        ...
                        if expectedresult in actualresult:
                            ...
                            if expectedresult in actualresult and BUNDLE_DOWNLOAD_URL_2 in details:
                                tdkTestObj_tr181.setResultStatus("SUCCESS")
                                print("ACTUAL RESULT %d: DeploymentUnit.2.URL verified: %s" % (step, details))
                                print("[TEST EXECUTION RESULT] : SUCCESS")
                                ...
                                if expectedresult in actualresult and EXPECTED_DU_STATUS in details:
                                    tdkTestObj_tr181.setResultStatus("SUCCESS")
                                    print("ACTUAL RESULT %d: DeploymentUnit.2.Status is Installed: %s" % (step, details))
                                    print("[TEST EXECUTION RESULT] : SUCCESS")
                                else:
                                    tdkTestObj_tr181.setResultStatus("FAILURE")
                                    print("ACTUAL RESULT %d: DeploymentUnit.2.Status check failed: %s" % (step, details))
                                    print("[TEST EXECUTION RESULT] : FAILURE")
                            else:
                                tdkTestObj_tr181.setResultStatus("FAILURE")
                                print("ACTUAL RESULT %d: DeploymentUnit.2.URL check failed: %s" % (step, details))
                                print("[TEST EXECUTION RESULT] : FAILURE")
                        else:
                    ...
                    tdkTestObj_tr181.setResultStatus("FAILURE")
                    print("ACTUAL RESULT %d: DeploymentUnit.1.Status check failed: %s" % (step, details))
                    print("[TEST EXECUTION RESULT] : FAILURE")
            else:
                tdkTestObj_tr181.setResultStatus("FAILURE")
                print("ACTUAL RESULT %d: DeploymentUnit.1.URL check failed: %s" % (step, details))
                print("[TEST EXECUTION RESULT] : FAILURE")
        else:
            tdkTestObj.setResultStatus("FAILURE")
