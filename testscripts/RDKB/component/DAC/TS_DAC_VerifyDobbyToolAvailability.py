...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_DAC_VerifyDobbyToolAvailability')
obj.configureTestCase(ip,port,'TS_DAC_VerifyDobbyToolAvailability')
...
if "SUCCESS" in loadmodulestatus_sys.upper() and "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        step += 1
        binary_name = DOBBYTOOL_BINARY
        # Check if DobbyTool binary exists
