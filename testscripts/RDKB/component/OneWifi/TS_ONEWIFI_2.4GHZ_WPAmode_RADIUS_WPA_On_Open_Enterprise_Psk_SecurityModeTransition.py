...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check RADIUS and WPA configurations on security mode transition(None->WPA-Enterprise->WPA-Personal) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_262</test_case_id>
    <test_objective>To check whether RADIUS and WPA configuration will be reset or not on security mode transition(None->WPA-Enterprise->WPA-Personal) for 2.4ghz</test_objective>
...
10. unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
            ...
            if expectedresult in actualresult:
                ...
                if "FAILURE" not in actualresult_all and expected_values == actual_values:
                    ...
                    if expectedresult in actualresult:
                        ...
                        paramName = "Device.WiFi.AccessPoint.1.Security.X_CISCO_COM_EncryptionMethod"
