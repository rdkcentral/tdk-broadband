...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ONEWIFI_CheckSecureHotspotSSIDConfiguration_AfterWiFiRestore</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_200</test_case_id>
...
9. Unload the modules
    ...
    <test_script>TS_ONEWIFI_CheckSecureHotspotSSIDConfiguration_AfterWiFiRestore</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckSecureHotspotSSIDConfiguration_AfterWiFiRestore');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckSecureHotspotSIDConfiguration_AfterWiFiRestore');
