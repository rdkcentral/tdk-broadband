...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_DFS_Channel_Set_Without_RFC_Enable')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    # Step 1: Confirm both DFS DMs are false
    paramNames = [
    ...
    if "FAILURE" not in actualresult_all and dfs_rfc == "false" and dfs_enable == "false":
        ...
        if expectedresult in actualresult:
            ...
            # Step 3: Attempt to set a DFS channel
            step += 1
            ...
            print("\n--- Reverting AutoChannelEnable to initial value ---")
