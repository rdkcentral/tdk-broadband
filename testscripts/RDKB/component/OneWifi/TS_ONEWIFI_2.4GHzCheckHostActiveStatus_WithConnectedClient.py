...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_2.4GHzCheckHostActiveStatus_WithConnectedClient</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_228</test_case_id>
...
6. If none of the host entry's layer 1 interface gives "Device.WiFi.SSID.1", return failure.
    ...
    <test_script>TS_ONEWIFI_2.4GHzCheckHostActiveStatus_WithConnectedClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHzCheckHostActiveStatus_WithConnectedClient');
