...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check RADIUS and WPA configurations on security mode transition(None->WPA2-Personal->WPA2-Enterprise) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_257</test_case_id>
    <test_objective>To check whether RADIUS and WPA configuration will be reset or not on security mode transition(None->WPA2-Personal->WPA2-Enterprise) for 2.4ghz</test_objective>
    <test_type></test_type>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition')
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if "FAILURE" not in actualresult_all and actual_values == expected_values:
                    ...
                    paramList = ("Device.WiFi.AccessPoint.1.Security.ModeEnabled|WPA2-Personal|string|"
                    ...
                    if expectedresult in actualresult:
                        ...
                        if "FAILURE" not in actualresult_all and actual_values == expected_values:
                            ...
                            tdkTestObj = obj.createTestStep("WIFIAgent_SetMultiple")
                            paramList = ("Device.WiFi.AccessPoint.1.Security.ModeEnabled|WPA2-Enterprise|string|"
                                "Device.WiFi.AccessPoint.1.Security.X_CISCO_COM_EncryptionMethod|%s|string|"
