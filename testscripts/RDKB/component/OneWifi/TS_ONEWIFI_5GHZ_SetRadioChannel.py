...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_SetRadioChannel</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_36</test_case_id>
...
7. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_SetChannel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_SetRadioChannel');
