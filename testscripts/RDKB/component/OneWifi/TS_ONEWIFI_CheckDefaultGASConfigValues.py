...
<xml>
  ...
  <name>TS_ONEWIFI_CheckDefaultGASConfigValues</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_123</test_case_id>
...
5.Unload the module
    ...
    <test_script>TS_ONEWIFI_CheckDefaultGASConfigValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckDefaultGASConfigValues');
