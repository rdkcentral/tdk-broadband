...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_OperatingStdFromSupportedStds</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_38</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_OperatingStdFromSupportedStds');
