...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_ONEWIFI_CheckResetCountIncrement_AfterWifiReboot</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_193</test_case_id>
...
8. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckResetCountIncrement_AfterWifiReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckResetCountIncrement_AfterWifiReboot');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckResetCountIncrement_AfterWifiReboot');
