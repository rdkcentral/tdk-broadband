...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_GetWiFiInterworkingEnable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_133</test_case_id>
...
5. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_GetWiFiInterworkingEnable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_GetWiFiInterworkingEnable');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_GetWiFiInterworkingEnable');
