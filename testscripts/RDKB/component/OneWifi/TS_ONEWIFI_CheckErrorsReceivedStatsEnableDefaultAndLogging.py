...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ONEWIFI_CheckErrorsReceivedStatsEnableDefaultAndLogging</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_208</test_case_id>
...
10. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckErrorsReceivedStatsEnableDefaultAndLogging</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckErrorsReceivedStatsEnableDefaultAndLogging');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckErrorsReceivedStatsEnableDefaultAndLogging');
