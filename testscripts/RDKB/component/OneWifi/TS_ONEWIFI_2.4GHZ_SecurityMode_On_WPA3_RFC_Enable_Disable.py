...
<xml>
  ...
  <test_cases>
    ...
    <test_objective>Verify Device.WiFi.AccessPoint.1.Security.ModeEnabled when WPA3_Personal_Transition.Enable is set to both true and false.</test_objective>
...
3.Get WPA3 RFC using Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable and security mode using Device.WiFi.AccessPoint.1.Security.ModeEnabled.
4.Enable WPA3 RFC using Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable
5.Get WPA3 RFC using Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable and security mode using Device.WiFi.AccessPoint.1.Security.ModeEnabled.
6.Disable WPA3 RFC using Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable.
7.Unload the module.
    </automation_approach>
    <expected_output>When WPA3_Personal_Transition.Enable is set to true, the security mode for Device.WiFi.AccessPoint.1.Security.ModeEnabled should be "WPA3-Personal-Transition".
