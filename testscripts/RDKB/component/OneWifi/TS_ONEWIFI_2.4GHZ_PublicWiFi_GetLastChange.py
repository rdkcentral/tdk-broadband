...
<xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_2.4GHZ_PublicWiFi_GetLastChange</name>
  <primitive_test_id/>
...
5. Restore value of Device.WiFi.SSID.5.Enable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_PublicWiFi_GetLastChange</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_PublicWiFi_GetLastChange');
