...
<xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_IsPublicWiFiSupported</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_50</test_case_id>
...
2. Using WIFIAgent_Get, getDevice.DeviceInfo.X_COMCAST-COM_xfinitywifiCapableCPE</automation_approch>
    ...
    <test_script>TS_ONEWIFI_IsPublicWiFiSupported</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_IsPublicWiFiSupported');
