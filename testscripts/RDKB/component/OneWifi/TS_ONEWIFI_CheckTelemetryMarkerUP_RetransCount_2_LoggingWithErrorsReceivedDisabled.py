...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_LoggingWithErrorsReceivedDisabled</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_204</test_case_id>
...
16. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_LoggingWithErrorsReceivedDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_LoggingWithErrorsReceivedDisabled');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_LoggingWithErrorsReceivedDisabled');
