...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzErrorSent</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_108</test_case_id>
...
7.Unload the Module
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzErrorSent</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzErrorSent');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzErrorSent');
