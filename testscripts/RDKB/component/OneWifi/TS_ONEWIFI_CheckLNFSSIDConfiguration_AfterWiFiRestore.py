...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_CheckLNFSSIDConfiguration_AfterWiFiRestore</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_199</test_case_id>
...
9. Unload the modules
    ...
    <test_script>TS_ONEWIFI_CheckLNFSSIDConfiguration_AfterWiFiRestore</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckLNFSSIDConfiguration_AfterWiFiRestore');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckLNFSIDConfiguration_AfterWiFiRestore');
