...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_ONEWIFI_GetNumberOfEntries</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_12</test_case_id>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ONEWIFI_GetNumberOfEntries.py)
3.Execute the generated Script(TS_ONEWIFI_GetNumberOfEntries.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_ONEWIFI_GetNumberOfEntries</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_GetNumberOfEntries');
