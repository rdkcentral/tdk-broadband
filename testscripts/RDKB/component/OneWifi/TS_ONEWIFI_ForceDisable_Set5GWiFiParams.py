...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_ForceDisable_Set5GWiFiParams</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_130</test_case_id>
...
"WIFI_ATTEMPT_TO_CHANGE_CONFIG_WHEN_FORCE_DISABLED " message should be present in WiFilog.txt.0  each time a set operation is done</expected_output>
    ...
    <test_script>TS_ONEWIFI_ForceDisable_Set5GWiFiParams</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_Set5GWiFiParams ');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_Set5GWiFiParams ');
