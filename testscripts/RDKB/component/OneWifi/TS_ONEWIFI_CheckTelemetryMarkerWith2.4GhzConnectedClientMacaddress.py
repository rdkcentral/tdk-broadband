...
<xml>
  ...
  <name>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzConnectedClientMacaddress</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_93</test_case_id>
...
5.Unload module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzConnectedClientMacaddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzConnectedClientMacaddress');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzConnectedClientMacaddress');
