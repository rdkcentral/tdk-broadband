...
<xml>
  ...
  <name>TS_ONEWIFI_CheckTelemetryMarkerVAPPERCENTUP</name>
...
8.Unload module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerVAPPERCENTUP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerVAPPERCENTUP');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerVAPPERCENTUP');
