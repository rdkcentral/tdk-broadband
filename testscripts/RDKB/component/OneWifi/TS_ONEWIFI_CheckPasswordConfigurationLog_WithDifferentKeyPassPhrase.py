...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_ONEWIFI_CheckPasswordConfigurationLog_WithDifferentKeyPassPhrase</name>
  <primitive_test_id/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithDifferentKeyPassPhrase');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithDifferentKeyPassPhrase');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithDifferentKeyPassPhrase');
