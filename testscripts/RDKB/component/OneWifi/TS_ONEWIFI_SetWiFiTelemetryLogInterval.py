...
<xml>
  ...
  <name>TS_ONEWIFI_SetWiFiTelemetryLogInterval</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_99</test_case_id>
...
6. Unload the Module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_SetWiFiTelemetryLogInterval</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetWiFiTelemetryLogInterval');
