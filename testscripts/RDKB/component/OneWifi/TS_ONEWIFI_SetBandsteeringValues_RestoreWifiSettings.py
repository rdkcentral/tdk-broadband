...
<xml>
  ...
  <name>TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_66</test_case_id>
...
9. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings');
obj2.configureTestCase(ip,port,'TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings');
pamobj.configureTestCase(ip,port,'TS_ONEWIFI_SetBandsteeringValues_RestoreWifiSettings');
