...
<xml>
  ...
  <name>TS_ONEWIFI_FactoryReset</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_10</test_case_id>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ONEWIFI_FactoryReset.py)
3.Execute the generated Script(TS_ONEWIFI_FactoryReset.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_ONEWIFI_FactoryReset</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_FactoryReset');
