...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_5GHzOffChannelTidleValidation</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_220</test_case_id>
...
11. Unload the wifiagent module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHzOffChannelTidleValidation</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzOffChannelTidleValidation');
