...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ONEWIFI_CheckGRETAPsPersistence_RouterToBridgeTransition</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_167</test_case_id>
...
11 Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckGRETAPsPersistence_RouterToBridgeTransition</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckGRETAPsPersistence_RouterToBridgeTransition');
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckGRETAPsPersistence_RouterToBridgeTransition');
