...
<xml>
  ...
  <name>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_Logging</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_Logging</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>CheckTelemetryMarkerUP RetransCount_2_Logging</test_objective>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_Logging</test_script>
    <skipped>No</skipped>
...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_202</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_Logging');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_2_Logging');
