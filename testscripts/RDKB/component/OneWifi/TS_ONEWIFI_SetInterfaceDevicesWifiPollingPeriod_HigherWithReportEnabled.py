...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_ONEWIFI_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_244</test_case_id>
...
9. Unload the module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled');
