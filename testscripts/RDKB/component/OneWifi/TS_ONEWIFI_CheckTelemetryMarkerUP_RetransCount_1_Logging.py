...
<xml>
  ...
  <name>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_1_Logging</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_201</test_case_id>
...
17. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_1_Logging</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_1_Logging');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerUP_RetransCount_1_Logging');
