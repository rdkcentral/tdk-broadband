...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>17</version>
  <name>TS_ONEWIFI_2.4GHzSetInterworkingConfiguration</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_223</test_case_id>
...
8. Unload the wifiagent module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHzSetInterworkingConfiguration</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHzSetInterworkingConfiguration');
