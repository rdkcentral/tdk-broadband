...
<xml>
  ...
  <name>TS_ONEWIFI_SetSSID_WithMultipleSpaces</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_86</test_case_id>
...
7. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_SetSSID_WithMultipleSpaces</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetSSID_WithMultipleSpaces');
