...
<xml>
  ...
  <name>TS_ONEWIFI_NumberOfSamples</name>
...
3. Set valid values ["1", "2000", "10000"] to NumberOfSamples parameter and verify if set operation is successful
4. Set invalid values ["0", "10001"] to NumberOfSamples parameter and verify if set operation fails
5. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_NumberOfSamples</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_NumberOfSamples');
            ...
            if expectedresult in actualresult:
                ...
                for sample in valid_list:
                    ...
                    if expectedresult in actualresult:
                        ...
                        print("NumberOfSamples successfully set to %s" %sample);
                    else:
                        set_success.append(0);
                        print("NumberOfSamples failed to set %s" %sample);
                ...
                for invalid_sample in invalid_list:
                    ...
                    if expectedresult in actualresult:
                        ...
                        print("NumberOfSamples failed to set  %s" %invalid_sample);
                    else:
                        set_failure.append(0);
                        print("NumberOfSamples successfully set for some invalid values %s" %invalid_sample);
