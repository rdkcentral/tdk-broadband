...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_SetInvalidReportWifiClientMacAddress</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_119</test_case_id>
...
5. Unload the module</automation_approch>
 ...
 should fail with invalid mac of length less than 12 Character</expected_output>
    ...
    <test_script>TS_ONEWIFI_SetInvalidReportWifiClientMacAddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetInvalidReportWifiClientMacAddress');
