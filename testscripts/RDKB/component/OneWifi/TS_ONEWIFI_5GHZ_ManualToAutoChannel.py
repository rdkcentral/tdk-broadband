...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_ManualToAutoChannel</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_32</test_case_id>
...
10.  Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_ManualToAutoChannel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_ManualToAutoChannel');
