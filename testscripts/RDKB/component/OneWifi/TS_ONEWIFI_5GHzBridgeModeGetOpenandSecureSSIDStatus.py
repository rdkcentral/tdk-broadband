...
<xml>
  ...
  <name>TS_ONEWIFI_5GHzBridgeModeGetOpenandSecureSSIDStatus</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_159</test_case_id>
...
7.Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHzBridgeMoodeGetOpenandSecureSSIDStatus</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzBridgeMode_GetOpenandSecureSSIDStatus');
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzBridgeMode_GetOpenandSecureSSIDStatus');
