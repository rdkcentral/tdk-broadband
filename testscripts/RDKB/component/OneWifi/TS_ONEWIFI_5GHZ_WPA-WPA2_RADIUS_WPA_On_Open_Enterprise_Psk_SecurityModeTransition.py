...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_WPA-WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check RADIUS and WPA configurations on security mode transition(None->WPA-WPA2-Enterprise->WPA-WPA2-Personal) for 5ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_265</test_case_id>
    <test_objective>To check whether RADIUS and WPA configuration will be reset or not on security mode transition(None->WPA-WPA2-Enterprise->WPA-WPA2-Personal) for 5ghz</test_objective>
...
9. Revert to initial security mode. 10. unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_WPA-WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_WPA-WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_WPA-WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if "FAILURE" not in actualresult_all and expected_values == actual_values:
                    ...
                    #Change security mode to WPA-WPA2-Enterprise, encryption method to AES and radius config parameters to new values
