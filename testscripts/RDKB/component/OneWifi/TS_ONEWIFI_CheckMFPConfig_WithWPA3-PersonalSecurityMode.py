...
<xml>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>CheckMFPConfig_WithWPA3-PersonalSecurityMode</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>2</test_case_id>
    <test_objective>CheckMFPConfig_WithWPA3-PersonalSecurityMode</test_objective>
    ...
    <expected_output>pass</expected_output>
    <priority>High</priority>
    <test_stub_interface>WIFIAgnt_St_Gt</test_stub_interface>
