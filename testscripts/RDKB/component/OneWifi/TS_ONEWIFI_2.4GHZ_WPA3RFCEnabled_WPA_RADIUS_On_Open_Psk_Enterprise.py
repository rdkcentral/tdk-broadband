...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_RADIUS_On_Open_Psk_Enterprise</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>When RFC WPA3-Personal-Transition is enabled check WPA and Radius configuration on security mode transition(None->WPA3-Personal->WPA3-Enterprise) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
10. Revert to initial security mode. 11. unload the module/automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_RADIUS_On_Open_Psk_Enterprise</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_RADIUS_On_Open_Psk_Enterprise')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_RADIUS_On_Open_Psk_Enterprise')
            ...
            if pre_req_set == 1:
                ...
                if expectedresult in actualresult:
                    ...
                    if "FAILURE" not in actualresult_all and actual_values == expected_values:
                        ...
                        #Change Security Mode to WPA3-Personal, Encryption mode to AES and update wpa config parameters
                        step = step + 1
