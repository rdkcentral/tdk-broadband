...
<xml>
  ...
  <name>TS_ONEWIFI_ForceDisable_CheckForLogs</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_124</test_case_id>
...
5.unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_ForceDisable_CheckForLogs</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_CheckForLogs');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_CheckForLogs');
