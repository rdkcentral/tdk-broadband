...
<xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_IsGREInterfaceStatusDown</name>
  <primitive_test_id/>
...
6. Restore value of Device.X_COMCAST_COM_GRE.Interface.1.Enable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_IsGREInterfaceStatusDown</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_IsGREInterfaceStatusDown');
