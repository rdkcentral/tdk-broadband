...
<xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_2.4GHZ_PublicWiFi_SetInvalidSecurityMode</name>
  <primitive_test_id/>
...
3. Set Device.WiFi.AccessPoint.5.Security.ModeEnabled to an invalid value
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_PublicWiFi_SetInvalidSecurityMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_PublicWiFi_SetInvalidSecurityMode');
