...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerWith5GhzRetryAndMultipleRetryCount</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_113</test_case_id>
...
9.Unload the Module
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWith5GhzRetryAndMultipleRetryCount</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith5GhzRetryAndMultipleRetryCount');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith5GhzRetryAndMultipleRetryCount');
