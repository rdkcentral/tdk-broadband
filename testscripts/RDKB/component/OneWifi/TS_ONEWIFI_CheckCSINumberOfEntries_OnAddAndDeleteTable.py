...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_CheckCSINumberOfEntries_OnAddAndDeleteTable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_172</test_case_id>
...
10. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckCSINumberOfEntries_OnAddAndDeleteTable</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckCSINumberOfEntries_OnAddAndDeleteTable');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckCSINumberOfEntries_OnAddAndDeleteTable');
