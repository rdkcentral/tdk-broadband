...
<xml>
  ...
  <name>TS_ONEWIFI_CheckBandsteeringEnable_WithSplitSSID</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_157</test_case_id>
...
5. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckBandsteeringEnable_WithSplitSSID</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringEnable_WithSpliSSID');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringEnable_WithSplitSSID');
