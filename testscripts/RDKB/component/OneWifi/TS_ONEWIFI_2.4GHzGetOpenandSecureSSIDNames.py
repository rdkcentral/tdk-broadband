...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_2.4GHzGetOpenandSecureSSIDNames</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_154</test_case_id>
...
6.Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHzGetOpenandSecureSSIDNames</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHzGetOpenandSecureSSIDNames');
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHzGetOpenandSecureSSIDNames');
