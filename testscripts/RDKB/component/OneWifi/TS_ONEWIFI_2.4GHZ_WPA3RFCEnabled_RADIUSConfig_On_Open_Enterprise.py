...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_RADIUSConfig_On_Open_Enterprise</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>When RFC WPA3-Personal-Transition is enabled check Radius configuration parameters on security mode transition(None-WPA3-Enterprise) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_258</test_case_id>
    <test_objective>When WPA3_Personal_Transition RFC Feature is enabled and When security mode transitions from None to WPA3-Enterprise (open-enterprise), check if the RADIUS configuration (Encryption method, Radius Server, Radius Port, Radius Secret) are updated. For 2.4ghz</test_objective>
...
5. Check RADIUS config using Device.WiFi.AccessPoint.1.Security.RadiusServerIPAddr, Device.WiFi.AccessPoint.1.Security.RadiusServerPort and Device.WiFi.AccessPoint.1.Security.RadiusSecret. Check if the values are 0.0.0.0, 0 and empty respectively.
...
8. Revert to initial security mode.9. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_RADIUSConfig_On_Open_Enterprise</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_RADIUSConfig_On_Open_Enterprise')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_RADIUSConfig_On_Open_Enterprise')
