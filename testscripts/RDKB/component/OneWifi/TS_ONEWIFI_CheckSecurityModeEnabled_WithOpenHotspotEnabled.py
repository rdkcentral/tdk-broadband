...
<xml>
  ...
  <name>TS_ONEWIFI_CheckSecurityModeEnabled_WithOpenHotspotEnabled</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_209</test_case_id>
...
9. Unload the module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckSecurityModeEnabled_WithOpenHotspotEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckSecurityModeEnabled_WithOpenHotspotEnabled');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckSecurityModeEnabled_WithOpenHotspotEnabled');
