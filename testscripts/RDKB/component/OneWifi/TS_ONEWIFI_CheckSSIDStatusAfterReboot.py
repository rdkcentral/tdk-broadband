...
<xml>
  ...
  <name>TS_ONEWIFI_CheckSSIDStatusAfterReboot</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_92</test_case_id>
...
7.Unload module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckSSIDStatusAfterReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckSSIDStatusAfterReboot');
