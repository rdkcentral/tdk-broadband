...
<xml>
  ...
  <name>TS_ONEWIFI_CheckPublicWifiEnableStatusPersistence_OnReboot</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_71</test_case_id>
...
6.Unload module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckPublicWifiEnableStatusPersistence_OnReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckPublicWifiEnableStatusPersistence_OnReboot');
obj2.configureTestCase(ip,port,'TS_ONEWIFI_CheckPublicWifiEnableStatusPersistence_OnReboot');
obj3.configureTestCase(ip,port,'TS_ONEWIFI_CheckPublicWifiEnableStatusPersistence_OnReboot');
