...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDUp</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDUp.py</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    ...
    <test_objective>2.4GHZ_IsPublicWiFiSSIDUp</test_objective>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDUp</test_script>
    <skipped>No</skipped>
...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_53</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDUp');
