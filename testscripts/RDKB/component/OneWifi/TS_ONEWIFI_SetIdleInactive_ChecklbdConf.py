...
<xml>
  ...
  <name>TS_ONEWIFI_SetIdleInactive_ChecklbdConf</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_67</test_case_id>
...
9. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_SetIdleInactive_ChecklbdConf</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetIdleInactive_ChecklbdConf');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_SetIdleInactive_ChecklbdConf');
obj2.configureTestCase(ip,port,'TS_ONEWIFI_SetIdleInactive_ChecklbdConf');
