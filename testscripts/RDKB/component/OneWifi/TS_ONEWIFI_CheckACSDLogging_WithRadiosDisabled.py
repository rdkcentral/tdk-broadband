...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_CheckACSDLogging_WithRadiosDisabled</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_210</test_case_id>
...
7. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckACSDLogging_WithRadiosDisabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckACSDLogging_WithRadiosDisabled');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckACSDLogging_WithRadiosDisabled');
