    ...
    for index in range(1,4):
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                step += 1
                print(f"\nTEST STEP {step}: Revert the Mac FilterAsBlackList {param2} to true")
                print(f"EXPECTED RESULT {step}: Should revert the Mac FilterAsBlackList {param2} to true successfully")
                tdkTestObj = obj.createTestStep("WIFIAgent_Set_Get")
                tdkTestObj.addParameter("paramName",param2)
                tdkTestObj.addParameter("paramValue","true")
                tdkTestObj.addParameter("paramType","bool")
                ...
                if expectedresult in actualresult and details != "":
                    tdkTestObj.setResultStatus("SUCCESS")
                    print(f"ACTUAL RESULT {step}: Successfully reverted the Mac FilterAsBlackList {param2} to true.")
                    print("[TEST EXECUTION RESULT] : SUCCESS")
                else:
                    tdkTestObj.setResultStatus("FAILURE")
                    print(f"ACTUAL RESULT {step}: Failed to revert Mac FilterAsBlacklist {param2} to true.")
                    print("[TEST EXECUTION RESULT] : FAILURE")
            else:
                #Set the result status of execution
                tdkTestObj.setResultStatus("FAILURE")
