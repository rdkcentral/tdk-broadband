...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>10</version>
  <name>TS_ONEWIFI_CheckPasswordConfigurationLog_WithSameKeyPassPhrase</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_168</test_case_id>
...
8. Unload the modules
    ...
    <test_script>TS_ONEWIFI_CheckPasswordConfigurationLog_WithSameKeyPassPhrase</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithSameKeyPassPhrase');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithSameKeyPassPhrase');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckPasswordConfigurationLog_WithSameKeyPassPhrase');
