...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>38</version>
  <name>TS_ONEWIFI_AddAndDeleteCSITableInstance_CheckDefaultValues</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_171</test_case_id>
...
9. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_AddAndDeleteCSITableInstance_CheckDefaultValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_AddAndDeleteCSITableInstance_CheckDefaultValues');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_AddAndDeleteCSITableInstance_CheckDefaultValues');
