...
<xml>
  ...
  <name>TS_ONEWIFI_AccessPointRetryLimit</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_18</test_case_id>
...
2.Python Script will be generated/overrided automically by Test Manager with provided arguments in configure page (TS_ONEWIFI_AccessPointRetryLimit.py)
3.Execute the generated Script(TS_ONEWIFI_AccessPointRetryLimit.py) using excution page of  Test Manager GUI
...
TestManager GUI will publish the result as PASS in Execution page</except_output>
    ...
    <test_script>TS_ONEWIFI_AccessPointRetryLimit</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_AccessPointRetryLimit');
