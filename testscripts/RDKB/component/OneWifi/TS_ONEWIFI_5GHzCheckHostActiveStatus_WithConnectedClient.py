...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_5GHzCheckHostActiveStatus_WithConnectedClient</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_229</test_case_id>
...
6. If none of the host entry's layer 1 interface gives "Device.WiFi.SSID.2", return failure.
    ...
    <test_script>TS_ONEWIFI_5GHzCheckHostActiveStatus_WithConnectedClient</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzCheckHostActiveStatus_WithConnectedClient');
