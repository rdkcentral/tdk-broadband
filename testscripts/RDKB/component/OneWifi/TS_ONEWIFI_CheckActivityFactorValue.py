...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_ONEWIFI_CheckActivityFactorValue</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_144</test_case_id>
...
6. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckActivityFactorValue</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckActivityFactorValue');
