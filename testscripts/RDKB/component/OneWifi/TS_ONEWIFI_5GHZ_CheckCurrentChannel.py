...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_CheckCurrentChannel</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_33</test_case_id>
...
5. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_PossibleChannel</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_CheckCurrentChannel');
