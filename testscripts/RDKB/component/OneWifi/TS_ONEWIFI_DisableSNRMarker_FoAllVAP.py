...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_DisableSNRMarker_FoAllVAP</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_88</test_case_id>
...
7. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_DisableSNRMarker_FoAllVAP</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_DisableSNRMarker_FoAllVAP');
