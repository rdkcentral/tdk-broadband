...
<xml>
  ...
  <name>TS_ONEWIFI_XHS2.4GHZ_EnableAdvertisement</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_90</test_case_id>
...
8. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_XHS2.4GHZ_EnableAdvertisement</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_XHS2.4GHZ_EnableAdvertisement');
