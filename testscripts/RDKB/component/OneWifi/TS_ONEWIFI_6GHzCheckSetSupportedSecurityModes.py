...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_6GHzCheckSetSupportedSecurityModes</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_227</test_case_id>
...
8. Unload the module
    ...
    <test_script>TS_ONEWIFI_6GHzCheckSetSupportedSecurityModes</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_6GHzCheckSetSupportedSecurityModes');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_6GHzCheckSetSupportedSecurityModes');
