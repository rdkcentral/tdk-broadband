...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ONEWIFI_DisableTelemetryCliStatList</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_97</test_case_id>
...
6. Unload the Module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_DisableTelemetryCliStatList</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_DisableWiFiTelemetryClistatlist');
