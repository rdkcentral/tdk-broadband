...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_OperatingStdFromSupportedStds</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_59</test_case_id>
...
5. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_OperatingStandard</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_OperatingStdFromSupportedStds');
