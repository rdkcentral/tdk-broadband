...
<xml>
  ...
  <name>TS_ONEWIFI_5GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_187</test_case_id>
...
11. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzCheckTransitionDisableUpdate_WithoutWPA3-Personal-Transition')
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    config = {
        "Device.WiFi.AccessPoint.2.Security.KeyPassphrase": "effect8080chord",
    ...
    if expectedresult in actualresult:
        ...
        tdkTestObj, actualresult, initial_config = getSecurityModeEnabledConfig(obj, initial_mode, 2)
            ...
            if pre_req_set == 1:
                ...
                if expectedresult in actualresult:
                    ...
                    for mode in ["None", "WPA-Personal", "WPA2-Personal", "WPA3-Personal"]:
                        ...
                        tdkTestObj, actualresult = setSecurityModeEnabledConfig(obj, mode, 2, config, currMode)
                    ...
                    if (revert_flag == 0 and initial_mode != currMode) or (revert_flag == 1 and initial_mode != "WPA2-Personal"):
                        ...
                        step = step + 1
                        tdkTestObj, actualresult = setSecurityModeEnabledConfig(obj, initial_mode, 2, initial_config, currMode)
                        ...
                        step = step + 1
                        tdkTestObj, actualresult, currMode = wifi_GetParam(obj, "Device.WiFi.AccessPoint.2.Security.ModeEnabled")
