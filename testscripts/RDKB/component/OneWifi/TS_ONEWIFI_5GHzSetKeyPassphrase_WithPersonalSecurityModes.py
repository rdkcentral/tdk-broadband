...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_5GHzSetKeyPassphrase_WithPersonalSecurityModes</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_163</test_case_id>
...
6. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHzSetKeyPassphrase_WithPersonalSecurityModes</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TS_ONEWIFI_5GHzSetKeyPassphrase_WithPersonalSecurityModes');
