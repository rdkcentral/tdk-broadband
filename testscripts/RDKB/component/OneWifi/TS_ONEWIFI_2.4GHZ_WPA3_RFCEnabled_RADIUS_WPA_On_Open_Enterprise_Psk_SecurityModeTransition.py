...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA3_RFCEnabled_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>When RFC WPA3-Personal-Transition is enabled check Radius and WPA configuration on security mode transition (None-&gt;WPA3-Enterprise-&gt;WPA3-Personal for 2.4GHZ</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
10. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA3_RFCEnabled_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3_RFCEnabled_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3_RFCEnabled_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
            ...
            if pre_req_set == 1:
                ...
                if expectedresult in actualresult:
                    ...
                    if "FAILURE" not in actualresult_all and actual_values == expected_values:
                        ...
                        paramList = ("Device.WiFi.AccessPoint.1.Security.ModeEnabled|WPA3-Enterprise|string|"
                        ...
                        if expectedresult in actualresult:
                            ...
                            if "FAILURE" not in actualresult_all and actual_values == expected_values:
                                ...
                                step = step +1
                                tdkTestObj = obj.createTestStep("WIFIAgent_SetMultiple")
                                paramList = ("Device.WiFi.AccessPoint.1.Security.ModeEnabled|WPA3-Personal|string|"
                                            "Device.WiFi.AccessPoint.1.Security.X_CISCO_COM_EncryptionMethod|%s|string|"
                                            "Device.WiFi.AccessPoint.1.Security.PreSharedKey|%s|string" % (ENCRYPTION_MODE,PRESHAREDKEY))
                                tdkTestObj.addParameter("paramList", paramList)
                                tdkTestObj.executeTestCase(expectedresult)
                                actualresult = tdkTestObj.getResult()
                                sleep(1)
