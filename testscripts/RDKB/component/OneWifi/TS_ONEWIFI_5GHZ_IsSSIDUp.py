...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_IsSSIDUp</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_21</test_case_id>
...
7.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from wifiagent stub.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_IsSSIDUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_IsSSIDUp');
