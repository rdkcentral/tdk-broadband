...
<xml>
  ...
  <name>TS_ONEWIFI_IsWiFiNameSpaces_Available</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_62</test_case_id>
...
5. Test Manager will publish the result in GUI as PASS/FAILURE</automation_approch>
    ...
    <test_script>TS_ONEWIFI_IsWiFiNameSpaces_Available</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_IsWiFiNameSpaces_Available');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_IsWiFiNameSpaces_Available');
