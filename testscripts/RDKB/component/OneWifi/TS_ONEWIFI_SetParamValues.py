...
<xml>
  ...
  <name>TS_ONEWIFI_SetParamValues</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_8</test_case_id>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_ONEWIFI_SetParamValues.py)
3.Execute the generated Script(TS_ONEWIFI_SetParamValues.py) using execution page of  Test Manager GUI
...
Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ONEWIFI_SetParamValues</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetParamValues');
