...
<xml>
  ...
  <name>TS_ONEWIFI_IsHostapdProcess_Up</name>
...
3. Unload modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_IsHostapdProcess_Up</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_IsHostapdProcess_Up');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_IsHostapdProcess_Up');
