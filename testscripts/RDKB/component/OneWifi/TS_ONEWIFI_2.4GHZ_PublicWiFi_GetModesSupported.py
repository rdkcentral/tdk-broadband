...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_PublicWiFi_GetModesSupported</name>
...
3. Check if it is in supported modes or not
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_PublicWiFi_GetModesSupported</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_PublicWiFi_GetModesSupported');
