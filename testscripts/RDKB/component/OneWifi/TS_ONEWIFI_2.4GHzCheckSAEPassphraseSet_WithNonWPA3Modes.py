...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_ONEWIFI_2.4GHzCheckSAEPassphraseSet_WithNonWPA3Modes</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_182</test_case_id>
...
5. Set Device.WiFi.AccessPoint.1.Security.ModeEnabled to personal security modes except WPA3 personal modes
6. For each of the non-WPA3 personal security modes set, check if the SAE Passphrase Device.WiFi.AccessPoint.1.Security.SAEPassphrase set operation returns failure. Cross verify with GET.
7. Revert the WPA3 RFC Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.WPA3_Personal_Transition.Enable status if required
8. Revert Device.WiFi.AccessPoint.1.Security.ModeEnabled to initial mode if required.
9. Unload the module.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHzCheckSAEPassphraseSet_WithNonWPA3Modes</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHzCheckSAEPassphraseSet_WithNonWPA3Modes');
