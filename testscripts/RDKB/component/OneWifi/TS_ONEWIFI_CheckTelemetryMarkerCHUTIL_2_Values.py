...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>6</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerCHUTIL_2_Values</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_150</test_case_id>
...
5. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerCHUTIL_2_Values</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerCHUTIL_2_Values');
