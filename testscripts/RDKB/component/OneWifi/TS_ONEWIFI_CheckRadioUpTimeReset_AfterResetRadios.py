...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_CheckRadioUpTimeReset_AfterResetRadios</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_195</test_case_id>
...
10. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckRadioUpTimeReset_AfterResetRadios</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckRadioUpTimeReset_AfterResetRadios');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckRadioUpTimeReset_AfterResetRadios');
