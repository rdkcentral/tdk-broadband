...
<xml>
  ...
  <name>TS_ONEWIFI_CheckNonRootSupport</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_151</test_case_id>
...
5. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckNonRootSupport</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
pamobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckNonRootSupport');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckNonRootSupport');
