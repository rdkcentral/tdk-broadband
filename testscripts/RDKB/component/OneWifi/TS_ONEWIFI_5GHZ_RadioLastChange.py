...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_5GHZ_RadioLastChange</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_34</test_case_id>
...
8. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_RadioLastChange</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_RadioLastChange');
