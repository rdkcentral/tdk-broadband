...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_ONEWIFI_SetSessionId</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_1</test_case_id>
...
2.Python Script will be generated/overrided automatically by Test Manager with provided arguments in configure page (TS_ONEWIFI_SetSessionId.py)
3.Execute the generated Script(TS_ONEWIFI_SetSessionId.py) using execution page of  Test Manager GUI
...
Test Manager GUI will publish the result as SUCCESS in Execution page</except_output>
    ...
    <test_script>TS_ONEWIFI_SetSessionId</test_script>
    <skipped>No</skipped>
    <release_version/>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetSessionId');
