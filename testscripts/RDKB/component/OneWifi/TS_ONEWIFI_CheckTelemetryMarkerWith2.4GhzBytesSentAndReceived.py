...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzBytesSentAndReceived</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_104</test_case_id>
...
9.Unload the Module
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzBytesSentAndReceived</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzBytesSentAndReceived');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith2.4GhzBytesSentAndReceived');
