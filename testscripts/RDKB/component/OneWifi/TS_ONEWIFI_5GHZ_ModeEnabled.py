...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_ModeEnabled</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_22</test_case_id>
...
7.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from pam stub.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_ModeEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_ModeEnabled');
