...
<xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_IsGRETunnelStatusUp</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_55</test_case_id>
...
6. Restore value of Device.X_COMCAST-COM_GRE.Tunnel.1.Enable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_IsGRETunnelStatusUp</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_IsGRETunnelStatusUp');
