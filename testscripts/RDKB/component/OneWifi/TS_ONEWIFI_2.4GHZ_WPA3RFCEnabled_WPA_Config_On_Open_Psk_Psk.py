...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_Config_On_Open_Psk_Psk</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>When RFC WPA3-Personal-Transition is enabled check WPA configuration on security mode transition (None-WPA3-Personal-WPA3-Personal-Transition) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
...
name: Device.WiFi.AccessPoint.1.Security.KeyPassphrase</input_parameters>
...
7. Then set to the next personal mode WPA3-Personal-Transition by setting Device.WiFi.AccessPoint.1.Security.ModeEnabled.
...
10. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_Config_On_Open_Psk_Psk</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_Config_On_Open_Psk_Psk')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA3RFCEnabled_WPA_Config_On_Open_Psk_Psk')
