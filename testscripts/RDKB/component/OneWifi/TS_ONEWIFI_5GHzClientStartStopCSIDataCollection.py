...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>7</version>
  <name>TS_ONEWIFI_5GHzClientStartStopCSIDataCollection</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_175</test_case_id>
...
14. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHzClientStartStopCSIDataCollection</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzClientStartStopCSIDataCollection');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_5GHzClientStartStopCSIDataCollection');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_5GHzClientStartStopCSIDataCollection');
