...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>Check RADIUS and WPA configurations on security mode transition(None->WPA-Personal->WPA-Enterprise) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_263</test_case_id>
    <test_objective>To check whether RADIUS and WPA configuration will be reset or not on security mode transition(None->WPA-Personal->WPA-Enterprise) for 2.4ghz</test_objective>
...
10.unload the moduleWhen security mode changes form open to psk (None to WPA-Personal) WPA config should set and When security mode changes from psk to enterprise(WPA-Personal to WPA-Enterprise) WPA config should reset</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPAmode_RADIUS_WPA_On_Open_Psk_Enterprise_SecurityModeTransition')
        ...
        if expectedresult in actualresult:
            ...
            if expectedresult in actualresult:
                ...
                if "FAILURE" not in actualresult_all and expected_values == actual_values:
                    ...
                    paramList = ("Device.WiFi.AccessPoint.1.Security.ModeEnabled|WPA-Personal|string|"
