...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_CheckSum_AFandCSTE_UpperLimit</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_146</test_case_id>
...
5. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckSum_AFandCSTE_UpperLimit</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckSum_AFandCSTE_UpperLimit');
