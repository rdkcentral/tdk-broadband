...
<xml>
  ...
  <name>TS_ONEWIFI_SetWifiClientDefaultReportingPeriod</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>TS_ONEWIFI_SetWifiClientDefaultReportingPeriod.py</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>3</test_case_id>
    <test_objective>TS_ONEWIFI_SetWifiClientDefaultReportingPeriod.py
</test_objective>
    ...
    <test_script>TS_ONEWIFI_SetWifiClientDefaultReportingPeriod</test_script>
    <skipped>No</skipped>
...
<xml>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_102</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_SetWifiClientDefaultReportingPeriod');
