...
<xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_5GHZ_IsPublicWiFiSSIDDown</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_52</test_case_id>
...
6. Restore value of Device.WiFi.SSID.6.Enable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_IsPublicWiFiSSIDDown</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_IsPublicWiFiSSIDDown');
