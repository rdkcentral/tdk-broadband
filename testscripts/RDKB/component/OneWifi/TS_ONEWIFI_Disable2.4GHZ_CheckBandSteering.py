...
<xml>
  ...
  <name>TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_65</test_case_id>
...
9. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering');
obj2.configureTestCase(ip,port,'TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering');
pamobj.configureTestCase(ip,port,'TS_ONEWIFI_Disable2.4GHZ_CheckBandSteering');
