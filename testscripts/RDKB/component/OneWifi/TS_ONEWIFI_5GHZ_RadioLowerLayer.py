...
<xml>
  ...
  <name>TS_ONEWIFI_5GHZ_RadioLowerLayer</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>TS_ONEWIFI_5GHZ_RadioLowerLayer.py</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>5</test_case_id>
    <test_objective>TS_ONEWIFI_5GHZ_RadioLowerLayer</test_objective>
    ...
    <test_script>TS_ONEWIFI_5GHZ_RadioLowerLayer</test_script>
    <skipped>No</skipped>
...
<?xml version="1.0" encoding="UTF-8"?><xml>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_35</test_case_id>
...
2.TDK Agent should be in running state or invoke it through StartTdk.sh script</pre_requisite>
    <api_or_interface_used>onewifi_DoNothing</api_or_interface_used>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_RadioLowerLayer');
