...
<xml>
  ...
  <name>TS_ONEWIFI_EnablePublicWiFi</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_49</test_case_id>
...
6. Restore value of Device.DeviceInfo.X_COMCAST_COM_xfinitywifiEnable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_EnablePublicWiFi</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_EnablePublicWiFi');
