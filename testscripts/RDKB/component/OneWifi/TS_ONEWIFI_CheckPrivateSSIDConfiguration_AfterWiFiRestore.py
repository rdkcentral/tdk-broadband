...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>13</version>
  <name>TS_ONEWIFI_CheckPrivateSSIDConfiguration_AfterWiFiRestore</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_196</test_case_id>
...
9. Unload the modules
    ...
    <test_script>TS_ONEWIFI_CheckPrivateSSIDConfiguration_AfterWiFiRestore</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckPrivateSSIDConfiguration_AfterWiFiRestore');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckPrivateSIDConfiguration_AfterWiFiRestore');
