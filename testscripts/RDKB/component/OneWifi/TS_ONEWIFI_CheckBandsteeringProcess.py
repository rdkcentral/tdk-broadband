...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_CheckBandsteeringProcess</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_64</test_case_id>
...
8. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckBandsteeringProcess</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringProcess');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringProcess');
obj2.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringProcess');
pamobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckBandsteeringProcess');
