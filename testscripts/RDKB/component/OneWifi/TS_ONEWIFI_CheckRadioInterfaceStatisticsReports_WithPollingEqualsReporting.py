...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>3</version>
  <name>TS_ONEWIFI_CheckRadioInterfaceStatisticsReports_WithPollingEqualsReporting</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_232</test_case_id>
...
15. Unload the modules.
    ...
    <test_script>TS_ONEWIFI_CheckRadioInterfaceStatisticsReports_WithPollingEqualsReporting</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckRadioInterfaceStatisticsReports_WithPollingEqualsReporting');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckRadioInterfaceStatisticsReports_WithPollingEqualsReporting');
