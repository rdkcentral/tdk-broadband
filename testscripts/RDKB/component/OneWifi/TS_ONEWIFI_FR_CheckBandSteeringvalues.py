...
<xml>
  ...
  <name>TS_ONEWIFI_FR_CheckBandSteeringvalues</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_69</test_case_id>
...
4. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_FR_CheckBandSteeringvalues</test_script>
    <skipped>No</skipped>
...
obj.configureTestCase(ip,port,'TS_ONEWIFI_FR_CheckBandSteeringvalues');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_FR_CheckBandSteeringvalues');
pamobj.configureTestCase(ip,port,'TS_ONEWIFI_FR_CheckBandSteeringvalues');
