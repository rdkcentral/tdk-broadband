...
<xml>
  ...
  <name>TS_ONEWIFI_ForceDisable_SetWiFiSSIDParams</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_131</test_case_id>
...
"WIFI_ATTEMPT_TO_CHANGE_CONFIG_WHEN_FORCE_DISABLED " message should be present in WiFilog.txt.0  each time a set operation is done when WiFi Force Disable is enabled</expected_output>
    ...
    <test_script>TS_ONEWIFI_ForceDisable_SetWiFiSSIDParams</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_SetWiFiSSIDParams');
obj1.configureTestCase(ip,port,'TS_ONEWIFI_ForceDisable_SetWiFiSSIDParams');
