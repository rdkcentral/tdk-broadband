...
<xml>
  ...
  <name>TS_ONEWIFI_CheckTelemetryMarkerWith5GHzConnectedClientMacaddress</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_94</test_case_id>
...
5.Unload module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWith5GHzConnectedClientMacaddress</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith5GHzConnectedClientMacaddress');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWith5GHzConnectedClientMacaddress');
