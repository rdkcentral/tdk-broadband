...
<xml>
  ...
  <name>TS_ONEWIFI_XHS5GHZ_EnableAdvertisement</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_91</test_case_id>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_XHS5GHZ_EnableAdvertisement');
