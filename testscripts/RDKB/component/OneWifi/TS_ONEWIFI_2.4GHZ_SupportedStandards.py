...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_SupportedStandards</name>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_63</test_case_id>
...
5.Test Manager will publish the result in GUI as PASS/FAILURE based on the response from wifiagentstub.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_SupportedStandards</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_SupportedStandards');
