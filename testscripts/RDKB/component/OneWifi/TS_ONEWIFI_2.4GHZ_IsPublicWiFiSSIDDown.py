...
<xml>
  <id/>
  <version>2</version>
  <name>TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDDown</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_51</test_case_id>
...
4. Restore value of Device.WiFi.SSID.5.Enable</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDDown</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_IsPublicWiFiSSIDDown');
