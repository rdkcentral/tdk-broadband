...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_ONEWIFI_CheckTelemetryMarkerWIFI_CAPSS_2_Logging</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_212</test_case_id>
...
16. Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckTelemetryMarkerWIFI_CAPSS_2_Logging</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWIFI_CAPSS_2_Logging');
sysObj.configureTestCase(ip,port,'TS_ONEWIFI_CheckTelemetryMarkerWIFI_CAPSS_2_Logging');
