...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>1</version>
  <name>TS_ONEWIFI_5GHZ_AutoChannelEnable</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_29</test_case_id>
...
6. Restrore values of Device.WiFi.Radio.2.AutoChannelEnable and Device.WiFi.Radio.2.Channel</automation_approch>
    ...
    <test_script>TS_ONEWIFI_5GHZ_AutoChannelEnable</test_script>
    <skipped>No</skipped>
    <release_version/>
    <remarks/>
  </test_cases>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_5GHZ_AutoChannelEnable');
