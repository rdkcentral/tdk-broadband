...
<xml>
  ...
  <name>TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To check whether RADIUS Configuration will be reset or not on security mode transition(open-enterprise-psk) for 2.4ghz</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_274</test_case_id>
    <test_objective>To check whether WPA Configuration will be reset or not on security mode transition(open-enterprise-psk) for 2.4ghz (AP1)</test_objective>
...
10. Unload the module</automation_approch>
    ...
    <test_script>TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition</test_script>
    <skipped></skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_2.4GHZ_WPA2_RADIUS_WPA_On_Open_Enterprise_Psk_SecurityModeTransition')
