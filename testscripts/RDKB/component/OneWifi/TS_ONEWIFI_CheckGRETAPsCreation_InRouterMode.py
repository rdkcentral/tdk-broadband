...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>9</version>
  <name>TS_ONEWIFI_CheckGRETAPsCreation_InRouterMode</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_166</test_case_id>
...
9 Unload the modules.</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckGRETAPsCreation_InRouterMode</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckGRETAPsCreation_InRouterMode');
wifiobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckGRETAPsCreation_InRouterMode');
