...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>12</version>
  <name>TS_ONEWIFI_CheckResetCountIncrement_AfterResetRadios</name>
  <primitive_test_id/>
  ...
  <test_cases>
    <test_case_id>TC_ONEWIFI_192</test_case_id>
...
8. Unload the modules</automation_approch>
    ...
    <test_script>TS_ONEWIFI_CheckResetCountIncrement_AfterResetRadios</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_ONEWIFI_CheckResetCountIncrement_AfterResetRadios');
sysobj.configureTestCase(ip,port,'TS_ONEWIFI_CheckResetCountIncrement_AfterResetRadios');
