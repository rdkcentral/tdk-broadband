...
obj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_JSON_ReportUpload')
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_JSON_ReportUpload')
wifiobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_JSON_ReportUpload')
