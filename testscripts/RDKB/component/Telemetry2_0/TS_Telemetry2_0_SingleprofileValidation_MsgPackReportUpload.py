...
obj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_MsgPackReportUpload')
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_MsgPackReportUpload')
wifiobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_MsgPackReportUpload')
