...
obj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_Using_ReportProfiles')
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_Using_ReportProfiles')
wifiobj.configureTestCase(ip,port,'TS_Telemetry2_0_SingleprofileValidation_Using_ReportProfiles')
