...
obj.configureTestCase(ip,port,'TS_Telemetry2_0_MultiprofileValidation_Using_ReportProfiles')
sysobj.configureTestCase(ip,port,'TS_Telemetry2_0_MultiprofileValidation_Using_ReportProfiles')
wifiobj.configureTestCase(ip,port,'TS_Telemetry2_0_MultiprofileValidation_Using_ReportProfiles')
...
if expectedresult in loadmodulestatus.upper() and expectedresult in loadmodulestatus_sys.upper() and expectedresult in loadmodulestatus_wifi.upper():
    ...
    if getStatus == 1:
        ...
        if (t2_flag or t2_revert_flag) == 1:
            ...
            print("Report Profiles JSON body to be set : %s" %report)
