...
pamobj.configureTestCase(ip,port,'TS_SANITY_DCAUtility_Scheduled');
...
if "SUCCESS" in loadmodulestatus.upper():
    ...
    if "SUCCESS" in loadmodulestatus1.upper():
        ...
        actual_details = tdkTestObj.getResultDetails();

        if expectedresult in actualresult:
            #Set the result status of execution
            tdkTestObj.setResultStatus("SUCCESS");
            print("TEST STEP 1: Get the Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable\n");
            ...
            if actual_details != "false":
                ...
                print("TEST STEP 1: Set the Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable to false\n");
                print("EXPECTED RESULT 1: Should set the Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable to false\n");
            ...
            if actual_details == "true":
                ...
                actualresult = tdkTestObj.getResult();
                details = tdkTestObj.getResultDetails();
                print("TEST STEP 1: Set the Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable to initial value\n");
                print("EXPECTED RESULT 1: Should set the Device.DeviceInfo.X_RDKCENTRAL-COM_RFC.Feature.Telemetry.Enable to initial value\n");
                print("ACTUAL RESULT 1:",details);
                if expectedresult in actualresult and details =="":
                    tdkTestObj.setResultStatus("SUCCESS");
                    print("[TEST EXECUTION RESULT] : SUCCESS");
