...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularStatisticsUpdate_iPhoneUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularStatisticsUpdate_iPhoneUSB')
