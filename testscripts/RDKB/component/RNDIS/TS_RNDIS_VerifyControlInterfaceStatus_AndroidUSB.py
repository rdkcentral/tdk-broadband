...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyControlInterfaceStatus_AndroidUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyControlInterfaceStatus_AndroidUSB')
