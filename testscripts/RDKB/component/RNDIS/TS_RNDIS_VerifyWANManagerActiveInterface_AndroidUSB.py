...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyWANManagerActiveInterface_AndroidUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyWANManagerActiveInterface_AndroidUSB')
        ...
        if expectedresult in actualresult and details != "":
            ...
            if current_active_interface == ANDROID_WAN_INTERFACE:
                ...
                print("ACTUAL RESULT %d: Current active interface matches - DM value: %s, Expected: %s" % 
                      (step, current_active_interface, ANDROID_WAN_INTERFACE))
                print("[TEST EXECUTION RESULT] : SUCCESS")
