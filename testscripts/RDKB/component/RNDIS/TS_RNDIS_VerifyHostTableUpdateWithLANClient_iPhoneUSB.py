...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyHostTableUpdateWithLANClient_iPhoneUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyHostTableUpdateWithLANClient_iPhoneUSB')
