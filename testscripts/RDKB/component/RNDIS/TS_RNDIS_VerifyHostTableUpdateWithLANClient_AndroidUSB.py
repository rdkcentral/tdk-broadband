...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyHostTableUpdateWithLANClient_AndroidUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyHostTableUpdateWithLANClient_AndroidUSB')
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult and details != "":
            ...
            if hostEntries.isdigit():
                ...
                # Step 3: Iterate through the Host Table and find LAN client entry and check if the host is active
                tdkTestObj_tr181, actualresult, clientDetected, clientIndex, step = traverse_host_table_for_client(obj, hostEntries, EXPECTED_LAYER1_INTERFACE_ETHERNET, step)
            else:
