...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularDeviceType_iPhoneUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularDeviceType_iPhoneUSB')
...
if "SUCCESS" in loadmodulestatus_sys.upper() and "SUCCESS" in loadmodulestatus.upper():
    ...
    if expectedresult in actualresult:
        ...
        if expectedresult in actualresult and details != "":
            ...
            step += 1
            # Step 3: Verify the Device Type is as Expected when RNDIS is active
