...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularDeviceType_AndroidUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyCellularDeviceType_AndroidUSB.py')
