...
ip = <ipaddress>
port = <port>
sysobj.configureTestCase(ip,port,'TS_RNDIS_VerifyControlInterfaceStatus_iPhoneUSB')
obj.configureTestCase(ip,port,'TS_RNDIS_VerifyControlInterfaceStatus_iPhoneUSB')
