...
<xml>
  ...
  <name>TS_USPPA_GetControllerObjectPath</name>
  ...
  <status>FREE</status>
  <!--  -->
  <synopsis>To send GET request to get Agent's Instantiated Controller Data Model when an object path is specified and receive a valid response via USP protocol</synopsis>
  <!--  -->
  <groups_id />
  <!--  -->
  ...
  <test_cases>
    <test_case_id>TC_USPPA_18</test_case_id>
    <test_objective>This test case is to send GET request to get Agent's Instantiated Controller Data Model when an object path is specified and receive a valid response via USP protocol</test_objective>
...
3. Configure USP controller to send GET request for Agent's Instantiated Controller Data Model when an object path is specified.
4. Once request is success, parse the USP response and list all the objects under that path.
5. Unload sysutil module</automation_approch>
    <expected_output>Agent's Instantiated Controller Data Model details when an object path is specified should be retrieved successfully via USP protocol</expected_output>
    <priority>High</priority>
    <test_stub_interface>sysutil</test_stub_interface>
    <test_script>TS_USPPA_GetControllerObjectPath</test_script>
    <skipped>No</skipped>
