...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_LMLITE_AdddDynamicTableRow')
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_LMLITE_AddDynamicTableRow')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_LMLITE_AddDynamicTableRow')
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and "SUCCESS" in loadmodulestatus3.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.LMLITE, setup_type, factoryReset, [obj1, obj2], rbusobj, "AddDynamicTableRow")
