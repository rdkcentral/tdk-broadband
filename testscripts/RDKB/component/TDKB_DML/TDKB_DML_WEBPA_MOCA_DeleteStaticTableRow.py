...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_MOCA_DeleteStaticTableRow')
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_MOCA_DeleteStaticTableRow')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_MOCA_DeleteStaticTableRow')
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and "SUCCESS" in loadmodulestatus3.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MOCA, setup_type, factoryReset, [obj1, obj2], rbusobj, "DeleteStaticTableRow")
