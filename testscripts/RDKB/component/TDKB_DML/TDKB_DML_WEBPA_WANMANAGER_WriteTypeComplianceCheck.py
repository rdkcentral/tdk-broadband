...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_WANMANAGER_WriteTypeComplianceCheck')
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_WANMANAGER_WriteTypeComplianceCheck')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_WANMANAGER_WriteTypeComplianceCheck')
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and "SUCCESS" in loadmodulestatus3.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.WANMANAGER, setup_type, factoryReset, [obj1, obj2], rbusobj, "writeTypeCompliance")
