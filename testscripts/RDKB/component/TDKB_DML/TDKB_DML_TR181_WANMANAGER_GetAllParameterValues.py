...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_WANMANAGER_GetAllParameterValues');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_WANMANAGER_GetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.WANMANAGER, setup_type, factoryReset, obj, rbusobj, "get");
