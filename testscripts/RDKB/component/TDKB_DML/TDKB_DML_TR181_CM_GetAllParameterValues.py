...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_CM_GetAllParameterValues');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_CM_GetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.CM, setup_type, factoryReset, obj, rbusobj, "get");
