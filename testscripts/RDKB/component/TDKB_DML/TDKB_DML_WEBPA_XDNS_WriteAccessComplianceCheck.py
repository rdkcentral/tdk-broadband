...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_XDNS_WriteAccessComplianceCheck');
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_XDNS_WriteAccessComplianceCheck')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_XDNS_WriteAccessComplianceCheck');
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and "SUCCESS" in loadmodulestatus3.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.XDNS, setup_type, factoryReset, [obj1, obj2], rbusobj, "writeAccessCompliance")
