...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_CR_GetAllParameterValues');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_CR_GetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.CR, setup_type, factoryReset, obj, rbusobj, "get");
