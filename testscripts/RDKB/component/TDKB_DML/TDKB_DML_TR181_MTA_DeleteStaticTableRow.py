...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_MTA_DeleteStaticTableRow');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_MTA_DeleteStaticTableRow');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MTA, setup_type, factoryReset, obj, rbusobj, "DeleteStaticTableRow");
