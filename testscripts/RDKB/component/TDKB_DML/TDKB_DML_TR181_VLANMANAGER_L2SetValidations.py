...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_VLANMANAGER_L2SetValidations');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_VLANMANAGER_L2SetValidations');
