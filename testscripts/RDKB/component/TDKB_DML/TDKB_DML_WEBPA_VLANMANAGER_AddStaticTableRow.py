...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_VLANMANAGER_AddStaticTableRow')
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_VLANMANAGER_AddStaticTableRow')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_VLANMANAGER_AddStaticTableRow')
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and "SUCCESS" in loadmodulestatus3.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.VLANMANAGER, setup_type, factoryReset, [obj1, obj2], rbusobj, "AddStaticTableRow")
