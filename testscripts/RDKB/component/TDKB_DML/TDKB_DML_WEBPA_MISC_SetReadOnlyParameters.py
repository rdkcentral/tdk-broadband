...
ip = <ipaddress>
port = <port>
obj1.configureTestCase(ip,port,'TDKB_DML_WEBPA_MISC_SetReadOnlyParameters');
obj2.configureTestCase(ip,port,'TDKB_DML_WEBPA_MISC_GetAllParameterValues')
rbusobj.configureTestCase(ip,port,'TDKB_DML_WEBPA_MISC_SetReadOnlyParameters');
...
if "SUCCESS" in loadmodulestatus1.upper() and "SUCCESS" in loadmodulestatus2.upper() and loadmodulestatus3.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MISC, setup_type, factoryReset, [obj1, obj2], rbusobj, "readOnlySet")
