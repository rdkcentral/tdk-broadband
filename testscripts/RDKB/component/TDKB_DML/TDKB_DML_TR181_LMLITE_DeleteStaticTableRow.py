...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_LMLITE_DeleteStaticTableRow');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_LMLITE_DeleteStaticTableRow');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.LMLITE, setup_type, factoryReset, obj, rbusobj, "DeleteStaticTableRow");
