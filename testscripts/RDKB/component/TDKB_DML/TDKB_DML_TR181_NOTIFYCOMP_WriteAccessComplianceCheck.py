...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_NOTIFYCOMP_WriteAccessComplianceCheck');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_NOTIFYCOMP_WriteAccessComplianceCheck');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.NOTIFYCOMP, setup_type, factoryReset, obj, rbusobj, "writeAccessCompliance");
