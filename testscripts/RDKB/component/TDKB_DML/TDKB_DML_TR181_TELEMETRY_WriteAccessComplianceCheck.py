...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_TELEMETRY_WriteAccessComplianceCheck');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_TELEMETRY_WriteAccessComplianceCheck');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.TELEMETRY, setup_type, factoryReset, obj, rbusobj, "writeAccessCompliance");
