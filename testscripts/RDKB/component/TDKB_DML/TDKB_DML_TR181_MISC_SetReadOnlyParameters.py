...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_MISC_SetReadOnlyParameters');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_MISC_SetReadOnlyParameters');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MISC, setup_type, factoryReset, obj, rbusobj, "readOnlySet");
