...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_WIFI_AddStaticTableRow');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_WIFI_AddStaticTableRow');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedtables, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.WIFI, setup_type, factoryReset, obj, rbusobj, "AddStaticTableRow");
