...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_MTA_GetAllParameterValues');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_MTA_GetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MTA, setup_type, factoryReset, obj, rbusobj, "get");
