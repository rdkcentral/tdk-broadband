...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_MESHAGENT_WriteAccessComplianceCheck');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_MESHAGENT_WriteAccessComplianceCheck');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.getAllParams_module(tdkbDmlModuleList.MESHAGENT, setup_type, factoryReset, obj, rbusobj, "writeAccessCompliance");
