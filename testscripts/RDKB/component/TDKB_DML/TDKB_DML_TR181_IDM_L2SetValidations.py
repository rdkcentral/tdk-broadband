...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_IDM_L2SetValidations');
rbusobj.configureTestCase(ip,port,'TDKB_DML_TR181_IDM_L2SetValidations');
...
if "SUCCESS" in loadmodulestatus.upper() and "SUCCESS" in loadmodulestatus1.upper():
    ...
    failedParams, moduleStatus = tdkbDmlUtility.setParams_module(tdkbDmlModuleList.IDM, setup_type, obj, rbusobj, testtype = "L2-set")
