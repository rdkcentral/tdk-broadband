...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TDKB_DML_TR181_LMLITE_SetAllParameterValues');
...
if "SUCCESS" in loadmodulestatus.upper() :
    ...
    failedParams, moduleStatus = tdkbDmlUtility.setAllParams_module(tdkbDmlModuleList.LMLITE, setup_type, factoryReset, obj);
