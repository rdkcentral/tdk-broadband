...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WEBCONFIG_PAMValidationUsingInvalidPortForwardingSubdoc</name>
  <primitive_test_id/>
  <primitive_test_name>Webconfig_DoNothing</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Validate PAM via Webconfig Feature using invalid PortForwarding subdoc</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WEBCONFIG_11</test_case_id>
    <test_objective>Validate PAM via Webconfig Feature using invalid PortForwarding subdoc</test_objective>
...
Device.NAT.PortMapping.{i}.</input_parameters>
    ...
    4. Enter invalid PortMapping subdoc information with invalid values via WebConfig server using curl command.
    ...
    <test_script>TS_WEBCONFIG_PAMValidationUsingInvalidPortForwardingSubdoc</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBCONFIG_PAMValidationUsingInvalidPortForwardingSubdoc')
sysobj.configureTestCase(ip,port,'TS_WEBCONFIG_PAMValidationUsingInvalidPortForwardingSubdoc')
    ...
    if expectedresult in actualresult:
        ...
        if actualresult in expectedresult and mac != "":
            ...
            if flag == 0:
                ...
                subdoc_type = "neg" # negative scenario with invalid values
                ...
                print("\nTEST STEP %d: Execute the curl command to update invalid %s subdoc" %(step, subdoc_name))
