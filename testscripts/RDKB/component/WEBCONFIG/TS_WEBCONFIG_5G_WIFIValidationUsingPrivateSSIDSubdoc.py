...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>4</version>
  <name>TS_WEBCONFIG_5G_WIFIValidationUsingPrivateSSIDSubdoc</name>
  <primitive_test_id/>
  <primitive_test_name>Webconfig_DoNothing</primitive_test_name>
  <primitive_test_version>2</primitive_test_version>
  <status>FREE</status>
  <synopsis>Validate WIFI via Webconfig Feature using 5g privatessid subdoc</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WEBCONFIG_19</test_case_id>
    <test_objective>Validate WIFI via Webconfig Feature using 5g privatessid subdoc</test_objective>
...
Device.WiFi.AccessPoint.{i}.Security.X_COMCAST-COM_KeyPassphrase</input_parameters>
    ...
    <expected_output>WIFI validation via Webconfig Feature using 5g privatessid subdoc should be successful.</expected_output>
    <priority>High</priority>
    <test_stub_interface>WEBCONFIG</test_stub_interface>
    <test_script>TS_WEBCONFIG_5G_WIFIValidationUsingPrivateSSIDSubdoc</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WEBCONFIG_5G_WIFIValidationUsingPrivateSSIDSubdoc')
sysobj.configureTestCase(ip,port,'TS_WEBCONFIG_5G_WIFIValidationUsingPrivateSSIDSubdoc')
