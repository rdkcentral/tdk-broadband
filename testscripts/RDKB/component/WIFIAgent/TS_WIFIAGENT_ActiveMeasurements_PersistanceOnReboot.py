...
<xml>
  ...
  <name>TS_WIFIAGENT_ActiveMeasurements_PersistanceOnReboot</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_238</test_case_id>
...
9. Unload wifiagent and tad modules</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_CheckActiveMeasurement_PersistenceOnReboot</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_CheckActiveMeasurement_PersistenceOnReboot');
obj1.configureTestCase(ip,port,'TS_WIFIAGENT_CheckActiveMeasurement_PersistenceOnReboot');
