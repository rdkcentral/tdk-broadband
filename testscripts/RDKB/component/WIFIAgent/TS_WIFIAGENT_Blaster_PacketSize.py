...
<xml>
  ...
  <name>TS_WIFIAGENT_Blaster_PacketSize</name>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_240</test_case_id>
    <test_objective>Packet Size in a blast should be successfully set to valid values and fail when set invalid values</test_objective>
...
5. Unload wifiagent module</automation_approch>
    ...
    <test_script>TS_WIFIAGENT_Blaster_PacketSize</test_script>
    <skipped>No</skipped>
        ...
        if proceed_flag == 1:
            ...
            if expectedresult in actualresult:
                ...
                for size in valid_list:
                    ...
                    tdkTestObj = obj.createTestStep("WIFIAgent_Set_Get");
                    tdkTestObj.addParameter("paramName","Device.WiFi.X_RDKCENTRAL-COM_Report.WifiClient.ActiveMeasurements.PacketSize");
                    tdkTestObj.addParameter("paramValue",size);
                ...
                for invalid_size in invalid_list:
                    ...
                    tdkTestObj = obj.createTestStep("WIFIAgent_Set_Get");
                    tdkTestObj.addParameter("paramName","Device.WiFi.X_RDKCENTRAL-COM_Report.WifiClient.ActiveMeasurements.PacketSize");
                    tdkTestObj.addParameter("paramValue", invalid_size);
                    tdkTestObj.addParameter("paramType","unsignedint");
