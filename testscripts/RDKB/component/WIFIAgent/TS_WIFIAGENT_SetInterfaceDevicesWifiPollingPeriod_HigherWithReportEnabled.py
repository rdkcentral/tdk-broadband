...
<?xml version="1.0" encoding="UTF-8"?><xml>
  <id/>
  <version>5</version>
  <name>TS_WIFIAGENT_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled</name>
  <primitive_test_id/>
  <primitive_test_name>WIFIAgent_Set_Get</primitive_test_name>
  <primitive_test_version>1</primitive_test_version>
  <status>FREE</status>
  <synopsis>Check if setting the Interface Device Wifi Report Polling Interval to a higher value than the current Polling Interval returns failure when Reports are enabled.</synopsis>
  <groups_id/>
  ...
  <test_cases>
    <test_case_id>TC_WIFIAGENT_243</test_case_id>
    <test_objective>Check if setting the Interface Device Wifi Report Polling Interval to a higher value than the current Polling Interval returns failure when Reports are enabled.</test_objective>
...
2. Get the initial values of Device.X_RDKCENTRAL-COM_Report.InterfaceDevicesWifi.PollingPeriod and Device.X_RDKCENTRAL-COM_Report.InterfaceDevicesWifi.Enabled
...
9. Unload the module.</automation_approch>
    <expected_output>Setting the Interface Device Wifi Report Polling Interval to a higher value than the current Polling Interval should return failure when Reports are enabled.</expected_output>
    <priority>High</priority>
    <test_stub_interface>wifiagent</test_stub_interface>
    <test_script>TS_WIFIAGENT_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled</test_script>
    <skipped>No</skipped>
...
ip = <ipaddress>
port = <port>
obj.configureTestCase(ip,port,'TS_WIFIAGENT_SetInterfaceDevicesWifiPollingPeriod_HigherWithReportEnabled');
